...
const VehiclePanel = ({setvehiclePanel,setRidePanel}) => {
       ...
       className=' w-[90%] p-3 mt-3 border border-gray-500 rounded-md'>
            <div className='flex gap-2 relative  w-full'>
              ...
              <div className='flex flex-col'>
                ...
                <h3 className='relative font-semibold'>{data} min away </h3>
                <p className='text-sm'>affordable compact price!</p>
              </div>
              <div className='flex justify-center items-center font-bold '>$35.00</div>
            </div>
      </div>
      <div
       onClick={()=>{
       ...
       className=' w-[90%] p-3 mt-3 border border-gray-500 rounded-md'>
            <div className='flex gap-2 relative   w-full'>
              ...
              <div className='flex justify-center items-center font-bold '>$15.00</div>
            </div>
      </div>
      <div 
       onClick={()=>{
        setvehiclePanel(false)
            ...
            <div className='flex gap-2 relative   w-full'>
              ...
              <div className='flex justify-center items-center font-bold '>$45.00</div>
            </div>
      </div>
